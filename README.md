...
```bash
wget https://github.com/jpkelly/clock8002/releases/download/v0.1.5/clock8002-v0.1.5-linux-arm64.tar.gz
```

### 2. Extract and install

```bash
tar xzf clock8002-v0.1.5-linux-arm64.tar.gz
cd clock8002-v0.1.5-linux-arm64
./install.sh
```
