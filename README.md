...
```bash
wget https://github.com/jpkelly/clock8002/releases/download/v1.3.1/clock8002-v1.3.1-default-linux-arm64.tar.gz
```

### 2. Extract and install

```bash
tar xzf clock8002-v1.3.1-default-linux-arm64.tar.gz
cd clock8002-v1.3.1-default-linux-arm64
./install.sh
```
...
| `[fps]` | LTC frame rate: 24, 25, or 30 (default: 25). Optional. |
