...
- Features: added dual HDMI output support — when "cue only" mode is on, HDMI-2 shows full-screen PerfectCue direction icons (forward/reverse/blank); when off, HDMI-2 mirrors the main clock display in real-time
