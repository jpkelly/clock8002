...
type clockOptions struct {
	...
	Matrix          string               `short:"m" long:"matrix" description:"Matrix to connect to" required:"true" default:"127.0.0.1:9999"`
	...
	CountdownColor  string               `long:"countdown-color" description:"Color for aux countdowns" default:"#FF0000"`
	TextColor       string               `long:"text-color" description:"Color for text" default:"#FF8000"`
	BackgroundColor string               `long:"background-color" description:"Background color" default:"#000000"`
