...
func saveHandler(w http.ResponseWriter, r *http.Request) {
	...
	errors += validateNumber(err, "Number font size")
	...
	errors += validateNumber(err, "Signal hardware brightness")
