################################################################################
#
# rpi-firmware — clock8002 override
#
# Pins to the firmware commit matching kernel 6.12.47 (Sep 2025),
# matching the raspi-firmware 1.20250915 release on the working piClock.
# The Buildroot 2025.02 upstream pins to April 2024 (6.6.28), whose DTB
# is missing BCM2712 pinctrl voltage-domain register entries needed by
# the 6.12.x pinctrl driver, causing SError on boot.
#
################################################################################
