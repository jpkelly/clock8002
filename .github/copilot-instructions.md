...
- The primary release artifact is the **installer tarball** (`clock8002-v1.x.y-<variant>-linux-arm64.tar.gz`), produced by `make release` in `v4/`. This is what gets attached to GitHub releases.
